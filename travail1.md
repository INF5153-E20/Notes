...
Vous pouvez obtenir le code source à mettre à jour sur [Github Classroom](https://classroom.github.com/a/jNioVm29).

### Partie 2 - Poker

_À venir en semaine 2!_

## Critères de correction

Comme il s'agit du premier travail et que les notions de conception objet n'ont pas encore été vues, la correction se fera en conséquence : je m'attends à du code cohérent qui passe les tests unitaires, respecte la structure en place pour la partie 1, et respecte les principes SOLID pour la partie 2.
